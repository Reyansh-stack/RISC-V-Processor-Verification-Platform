...
module top_module(
    ...
    wire [15:0] sumhigh0cin;
    wire [15:0] sumhigh1cin;
    add16 lowerbits(.a(a[15:0]),.b(b[15:0]),.cin(1'b0),.sum(sum[15:0]),.cout(coutlow));
    add16 higherbits0cin(.a(a[31:16]),.b(b[31:16]),.cin(1'b0),.sum(sumhigh0cin),.cout());
    add16 higherbits1cin(.a(a[31:16]),.b(b[31:16]),.cin(1'b1),.sum(sumhigh1cin),.cout());
    assign sum[31:16] = (coutlow) ? sumhigh1cin : sumhigh0cin;
